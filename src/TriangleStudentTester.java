...
public class TriangleStudentTester {
 ...
 //       final double EPSILON = 0.001;
        ...
        if (!(t1.getPoint1().equals(new Point (1.0,1.0)))||!(t1.getPoint2().equals(new Point (3.0,3.0)))||!(t1.getPoint3().equals(new Point (3.3,1.1))))
            ...
            System.out.println("\t OK -  constructor 2 and getters,expected {(1.0,1.0),(3.0,3.0),(3.3,1.1)} actual= "+t1);
        ...
        if (!(t2.getPoint1().equals(new Point (1.0,1.0)))||!(t2.getPoint2().equals(new Point (3.0,3.0)))||!(t2.getPoint3().equals(new Point (3.3,1.1))))
            ...
            System.out.println("\t OK -  constructor 3 and getters,expected {(1.0,1.0),(3.0,3.0),(3.3,1.1)} actual= "+t2);
        ...
        if (!(t3.getPoint1().equals(new Point (1.0,1.0)))||!(t3.getPoint2().equals(new Point (3.0,3.0)))||!(t3.getPoint3().equals(new Point (3.3,1.1))))
            ...
            System.out.println("\t OK -  copy constructor  and getters,expected {(1.0,1.0),(3.0,3.0),(3.3,1.1)} actual= "+t3);
        ...
        if (t9.isAbove(t10)) 
            ...
            System.out.println("\t OK - t9.isAbove(t10) expected false ; actual=" + t9.isAbove(t10) + ";  t9=" + t9 + " t10=" + t10);
        ...
        Triangle t21 = new Triangle(1.0,3.0,1.0,1.0,3.0,3.0);
        Point p3=t21.highestPoint();
        if (!(p3.equals(new Point(1.0,3.0))))
            System.out.println("\t ERROR - t21.highestPoint() expected (1.0,3.0) ; actual=" + t21.highestPoint() + ";  t21=" + t21 );
        else  
            System.out.println("\t OK - t21.highestPoint() expected (1.0,3.0) ; actual=" + t21.highestPoint() + ";  t21=" + t21 );
